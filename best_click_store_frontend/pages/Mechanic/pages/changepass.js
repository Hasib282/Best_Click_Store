...
export default function ChangePassword() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!new_password) {
            ...
            setNewPassError('Password Must contain one upper letter,lower letter,digit and special character');
            formIsValid = false;
        }
    ...
    async function changePass() {
        try {
            ...
            const response = await axios.put(process.env.NEXT_PUBLIC_BACKEND_URL + 'changepass?email=' + email, data, {
                headers: {
            ...
            <MechanicLayout>
                ...
                <div className="detaills w-full float-left justify-center align-items-center flex flex-row  mt-10">
                    <form onSubmit={handleSubmit}>
                        ...
                        <br />{newPassError && <b className="text-red-600">{newPassError}</b>}<br />
